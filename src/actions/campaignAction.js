...
export const changeCampaignStatusAction = (input) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(`${url}/changeCampaignStatus`, input);
    dispatch({
