...
export function screenCampaignMonitoringReducer(state = {}, action) {
  switch (action.type) {
    case SCREEN_CAMPAIGN_MONITORING_REQUEST:
      return { loading: true };
    case SCREEN_CAMPAIGN_MONITORING__SUCCESS:
      return {loading: false, success: true, data: action.payload };
    case SCREEN_CAMPAIGN_MONITORING__FAIL:
      return {loading: false, error: action.payload };
    case SCREEN_CAMPAIGN_MONITORING__RESET:
      return {};
    default:
      return state;
  }
